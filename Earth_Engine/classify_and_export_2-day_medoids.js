...
var AOI_DESIGNATION = 'OST'; // set to 'PTM' or 'OST'
var YEAR            = '2013'; //FOR image collection path  

var START_DATE = '2013-05-01';
var END_DATE   = '2013-09-30';
...
function queueAssetExport(classifiedImage, exportId, windowStart, windowEnd, countRaw, countUsed) {
  ...
  Export.image.toAsset({
    ...
    assetId: 'projects/vernal-signal-270100/assets/ClassifiedMosaics/' + AOI_DESIGNATION + YEAR + '/' + exportId,
    scale: EXPORT_SCALE,
    crs: EXPORT_CRS,
    region: exportRegion,
    pyramidingPolicy: {
